...
#notice that: the xxx_interface.h/cpp files were put into 'gxde-file-manager-lib' not 'gxde-file-manager-daemon'.
qdbusxml2cpp -c TagManagerDaemonInterface -p ../../gxde-file-manager-lib/controllers/interface/tagmanagerdaemon_interface tagmanagerdaemon.xml

...
/*
 * The menu interface of gxde-file-manager
 * 文件管理器的右键菜单插件接口
*/
...
public:
     ...
     * \param onDesktop: menu got triggered on desktop (gxde-desktop-panel) or not
     * \return QList<QAction*>: QAction pointer list
     */
    /*!
...
/*
 * The property dialog expand info interface of gxde-file-manager
 * 文件管理器的属性对话框插件接口
*/
...
#define MenuInterface_iid "com.deepin.gxde-file-manager.MenuInterface.V1"

Q_DECLARE_INTERFACE(MenuInterface, MenuInterface_iid)

#define PropertyDialogExpandInfoInterface_iid "com.deepin.gxde-file-manager.PropertyDialogExpandInfoInterface"

...
#include <QWidget>
/*
 * The view interface of gxde-file-manager
 * 文件管理器的视图插件接口
*/
...
public:
    ...
    /*!
     * \brief createView
     * \return QWidget* : the view will be registered into gxde-file-manager view
     */
    /*!
     * \brief createView
...
#define ViewInterface_iid "com.deepin.gxde-file-manager.ViewInterface"
